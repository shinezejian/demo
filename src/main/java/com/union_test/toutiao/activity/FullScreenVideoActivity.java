...
//                    mttFullVideoAd.showFullScreenVideoAd(FullScreenVideoActivity.this);
    ...
    private void loadAd(String codeId, int orientation) {
        ...
        AdSlot adSlot = new AdSlot.Builder()
                ...
                .setOrientation(orientation)//required parameter ，Set how you wish the video ad to be displayed ,choose from TTAdConstant.HORIZONTAL 或 TTAdConstant.VERTICAL
                .build();
        //step5:request ad
